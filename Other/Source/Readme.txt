...
user in an INI file next to RapidEEPortable.exe called RapidEEPortable.ini.
...
copy AppNamePortable.ini from this directory to RapidEEPortable.ini next to
RapidEEPortable.exe. The options in the INI file are as follows:
